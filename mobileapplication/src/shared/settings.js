...
var liveServerSSL = false; // Determines whether the live server should be accessed via SSL. Only enable if you know the live server has a correctly configured SSL
